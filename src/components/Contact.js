...
function Contact() {
  const contacts = [
    { icon: <FaEnvelope />, label: 'Email', value: 'ashewatkar713@gmail.com' },
    { icon: <FaLinkedin />, label: 'LinkedIn', value: 'linkedin.com/in/akshay-ns' },
    { icon: <FaGithub />, label: 'GitHub', value: 'github.com/akcaesar' },
  ];
